...
- [[#Few troubleshooting techniques|Few troubleshooting techniques]]
- [[#Things you should prepare ahead of time|Things you should prepare ahead of time]]
- [[#Problems we faced during the fair|Problems we faced during the fair]]
- [[#Recommendation for future Improvements|Recommendation for future Improvements]]
...
## Things you should prepare ahead of time
- Bring a Wifi router for the best connection(field house could be unreliable)
- Bring a big monitor or any monitor(we had a member who had access to tech crew's equipment, so figure it out)
- Have a cart to move the robot. Kiser has one cart you can use
- You might not get a confirmation email, so don't worry too much if you don't receive anything
